...
hi Normal       guifg=#00ffff  ctermfg=darkcyan       guibg=#111111 ctermbg=black
hi Folded       guifg=#c2bfa5  ctermfg=lightgray  guibg=#202020 ctermbg=black  gui=underline cterm=underline
hi LineNr       guifg=#928c75  ctermfg=darkgray   guibg=#111111 ctermbg=black
hi Directory    guifg=#00bbdd  ctermfg=cyan       guibg=#111111 ctermbg=black
hi NonText      guifg=#77ff22  ctermfg=yellow     guibg=#111111 ctermbg=black  gui=bold cterm=bold
hi SpecialKey   guifg=#559933  ctermfg=green      guibg=#111111 ctermbg=black
...
hi Title        guifg=#dd4452 ctermfg=red       guibg=#111111 ctermbg=black  gui=bold cterm=bold
hi Question     guifg=#66d077 ctermfg=green     guibg=#111111 ctermbg=black
hi MoreMsg      guifg=#39d049 ctermfg=green     guibg=#111111 ctermbg=black
hi ErrorMsg     guifg=#ffffff ctermfg=white     guibg=#ff0000 ctermbg=red    gui=bold cterm=bold
hi WarningMsg   guifg=#ccae22 ctermfg=yellow    guibg=#111111 ctermbg=black  gui=bold cterm=bold


" syntax highlighting groups (:help group-name)

hi Comment      guifg=#b0b010  ctermfg=brown       guibg=#111111 ctermbg=black
hi Keyword      guifg=#ffffff  ctermfg=white       guibg=#111111 ctermbg=black
hi Statement    guifg=#ffffff  ctermfg=white       guibg=#111111 ctermbg=black  gui=bold cterm=bold 
hi StorageClass guifg=#b0ffb0  ctermfg=white       guibg=#111111 ctermbg=black  gui=bold cterm=NONE
hi Structure    guifg=#b0ffb0  ctermfg=white       guibg=#111111 ctermbg=black  gui=bold cterm=NONE
hi Type         guifg=#ffffff  ctermfg=white       guibg=#111111 ctermbg=black  gui=NONE
hi Identifier   guifg=#ffffff  ctermfg=white       guibg=#111111 ctermbg=black  gui=NONE cterm=NONE
hi Operator     guifg=#ffffff  ctermfg=white       guibg=#111111 ctermbg=black
hi Delimiter    guifg=#ffffff  ctermfg=white       guibg=#111111 ctermbg=black
hi Todo         guifg=#a00000  ctermfg=darkred     guibg=#111111 ctermbg=black  gui=bold cterm=bold
hi Error        guifg=#ffffff  ctermfg=white       guibg=#ff0000 ctermbg=red
hi Function     guifg=#2080ff  ctermfg=blue        guibg=#111111 ctermbg=black
hi Underlined   guifg=#80a0ff  ctermfg=cyan        guibg=#111111 ctermbg=black  gui=underline cterm=underline
hi Ignore       guifg=#888888  ctermfg=darkgray    guibg=#111111 ctermbg=black
hi Constant     guifg=#00ff20  ctermfg=green       guibg=#111111 ctermbg=black
hi Number       guifg=#00ff20  ctermfg=green       guibg=#111111 ctermbg=black
hi PreProc      guifg=#00b000  ctermfg=darkgreen   guibg=#111111 ctermbg=black
hi Macro        guifg=#00b000  ctermfg=darkgreen   guibg=#111111 ctermbg=black
hi Special      guifg=#ffff00  ctermfg=yellow      guibg=#111111 ctermbg=black
